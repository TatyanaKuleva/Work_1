...
from mypyc.transform.refcount import after_branch_decrefs

from src.func_get_data import read_excel_file
from src.views import get_start_of_period,greeting_user, filtr_transction_by_date, filtr_operation_with_cashback, agregate_transaction_card, get_top_transaction, get_currency_stocks_rate
...
def main(current_date: str):
    ...
    data_rate_by_users_curr_stock = get_currency_stocks_rate()
    result['currency_rates'] = data_rate_by_users_curr_stock
